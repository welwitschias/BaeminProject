	...
	<div class="detail_box">
		<div class="order_cont">
			...
			<div class="order_info">
				<div>
					주문일시 :<fm:formatDate value="${orderDetail.orderDate }" pattern="yyyy년 MM월 dd일 (E) a hh:mm" />
				</div>
		...
		<ul class="order_menu">
			<c:forEach begin="0" end="${fn:length(cart) -1 }" var="i">
				<li>
					<div>
						<span>${cart[i].foodName } ${cart[i].amount }개</span>
					</div>
		...
		<div class="price">
			<div>
				<span>총 주문금액 </span>
				<span><fm:formatNumber value="${orderDetail.totalPrice }" pattern="###,###" />원</span>
			</div>
			<div>
				<span>배달팁 </span>
				<span><fm:formatNumber value="${orderDetail.deliveryTip }" pattern="###,###" />원</span>
			</div>
			<div>
